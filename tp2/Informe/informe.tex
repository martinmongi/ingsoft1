...
\newcommand{\tuple}[1]{\ensuremath{\left \langle #1 \right \rangle }}pdf
...
\vspace{\baselineskip}
    \begin{center}
                \includegraphics[scale=0.55, page=1]{imagenes/clases/DiagramadeClases.png}
                \\
                \vspace{1pt}
...
\vspace{\baselineskip}
    \begin{center}
                \includegraphics[scale=0.6, page=2]{imagenes/clases/DiagramadeClases.png}
                \\
                \vspace{1pt}
...
\vspace{\baselineskip}
\vspace{-10px}
\noindent\textbf{Trazabilidad}: Este diagrama FSM se relaciona con el FSM de \textit{Servidor Local}.\\

\subsubsection{Servidor Local}

\vspace{\baselineskip}
    \begin{center}
                \includegraphics[scale=0.70, page=1]{imagenes/fsm/FSMServidorLocal.pdf}
                \\
                \vspace{1pt}
                \footnotesize\textit{}
        \end{center}
\vspace{\baselineskip}
\vspace{-10px}
\noindent\textbf{Trazabilidad}: Este diagrama FSM se relaciona con los FSM de \textit{Centro Nacional de Cómputo y Máquina de Sufragio}.\\

\subsubsection{Máquina de Sufragio}

\vspace{\baselineskip}
    \begin{center}
                \includegraphics[scale=0.65, page=1]{imagenes/fsm/FSMMaquinaEmisoradeSufragios.pdf}
                \\
                \vspace{1pt}
                \footnotesize\textit{}
        \end{center}
\vspace{\baselineskip}
\vspace{-10px}
\noindent\textbf{Trazabilidad}: Este diagrama se relaciona con los casos de uso \textit{Votando candidatos(1), Imprimiendo boleta(2), Abriendo comicios(5), Cerrando comicios(6), Ingresando resultados(7), Consultando resultados(12) y Consultando candidatos(13)} y con el FSM de \textit{Servidor Local}.\\
