...
\def\arraystretch{1.3}
  \begin{tabular}{p{9cm} | p{7cm}}
    ...
    \hline
    5 El \textbf{\textit{presidente de mesa}} elige la opcion de \textit{''ingresar número de mesa''}.
    & \\
...
\noindent\textbf{Caso de Uso: 9. Actualizando software de la maquina emisora de sufragios}\\
...
\noindent\textbf{Caso de Uso: 10. Actualizando datos de maquina emisora de sufragios}\\
\textbf{Actor: } Encargado de la maquina.\\
\textbf{Pre: } No se abrieron los comicios.\\
...
\newpage
\noindent\textbf{Caso de Uso: 11. Consultando resultados}\\
\textbf{Actor: } Fiscal.\\
\textbf{Pre: } Se cerraron los comicios.\\
...
\noindent\textbf{Caso de Uso: 12. Consultando candidatos}\\
\textbf{Actor: } Fiscal.\\
\textbf{Pre: } True.\\
...
\newpage
\noindent\textbf{Caso de Uso: 13. Cargando padrón}\\
...
\noindent\textbf{Caso de Uso: 14. Cargando candidatos}\\
\textbf{Actor: } Encargado del CCN.\\
\textbf{Pre: } No se abrieron los comicios.\\
